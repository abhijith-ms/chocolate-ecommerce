      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-serif text-xl font-bold">Ali & Company</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Crafted with passion in Bahrain, our authentic international cuisine brings together 
              the finest flavors from around the world. Each dish is prepared with love and tradition.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a 
                  href="mailto:info@alicompany.com" 
                  className="text-gray-300 hover:text-chocolate-accent transition-colors"
                >
                  info@alicompany.com
                </a>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            © 2024 Ali & Company. All rights reserved.
          </p>
